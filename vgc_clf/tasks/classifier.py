...
from vgc_clf.utils import DataFrameUtils as DfUtils
...
df_dgn = DfUtils.get_patients_data_frame(df=df, patient_column_name="patient",
                                         patient_info_columns=["patient", "group", "age", "sex",
                                                               "oculomotor_deficiences", "school_performance",
                                                               "diagnosis"])

df_val, df_fit, train_index, _ = DfUtils.get_train_validation_from_data_frame(signal_df=df, patients_df=df_dgn,
